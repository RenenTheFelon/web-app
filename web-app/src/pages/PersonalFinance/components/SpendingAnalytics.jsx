  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h3 className="text-2xl font-bold text-gray-800">Spending Analytics</h3>
        <select
          value={timeRange}
      ...
      {expenses.length === 0 ? (
        ...
        <>
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <h4 className="text-lg font-bold text-gray-800 mb-4">Spending by Category</h4>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <h4 className="text-lg font-bold text-gray-800 mb-4">Category Distribution</h4>
          ...
          {getMonthlyTrend().length > 1 && (
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              <h4 className="text-lg font-bold text-gray-800 mb-4">Monthly Trend</h4>
              <div className="space-y-2">
                {getMonthlyTrend().map(([month, amount]) => (
                  <div key={month} className="flex items-center gap-3">
                    <div className="w-20 text-sm text-gray-600 font-medium">{month}</div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <h4 className="text-lg font-bold text-gray-800 mb-4">Top Expenses</h4>
            <div className="space-y-2">
              {expenses
