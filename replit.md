...
- **Personal Finance Tools**: Includes six core tools:
    ...
    2.  **Income & Expense Tracker**: Unified ledger, summary views, and forms for income/expense tracking with custom categories and running balance calculations.
    3.  **Recurring Transaction Manager**: Manages recurring income/expense templates with various frequencies and automatic calendar projections.
    ...
    6.  **Net Worth Tracker**: Manages assets/liabilities and calculates historical net worth.
